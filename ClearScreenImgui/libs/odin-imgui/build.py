...
wanted_backends = ["vulkan", "sdl2", "opengl3", "sdlrenderer2", "sdl3", "sdlrenderer3", "glfw", "dx11", "dx12", "osx", "metal", "wgpu", "webgl"]
...
backend_deps = {
	...
	"sdl3":   { "repo": "https://github.com/libsdl-org/SDL.git",               "commit": "release-3.2.20", "path": "SDL3" },
	...
	"wgpu":   { "repo": "https://github.com/webgpu-native/webgpu-headers.git", "commit": "5a6c263",        "path": "webgpu-headers/webgpu", "include": "webgpu-headers" },
}
